...
class Api
{
    ...
    protected ?int $userAuthTypeId = null;
    protected ?int $userAuthSchoolId = null;

    public function authToken (int|array $typeId): bool
    {
        ...
        $this->userAuthTypeId = $user->getTypeId();
        $this->userAuthSchoolId = $user->getSchoolId();
