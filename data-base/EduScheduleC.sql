...
INSERT INTO plans (name, description, price, max_students, max_teachers, status) VALUES
('Plano Basico', 'Plano inicial para escolas pequenas.', 49.90, 50, 5, 1),
('Plano Intermediario', 'Plano para escolas em crescimento.', 99.90, 200, 20, 1),
('Plano Premium', 'Plano completo para escolas com alta demanda.', 199.90, 1000, 100, 1);
